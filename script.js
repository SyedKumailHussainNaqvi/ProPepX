...
// Professional full-resolution figure opening.
// Click any manuscript figure to open the original image in a new browser tab.
(function () {
  const images = document.querySelectorAll('img[data-zoom="true"]');
  images.forEach((img) => {
    img.setAttribute('tabindex', '0');
    img.setAttribute('role', 'button');
    img.setAttribute('aria-label', 'Open full-resolution figure in a new tab');

    const openFullFigure = () => {
    ...
    img.addEventListener('click', openFullFigure);
